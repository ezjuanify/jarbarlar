...
class Htaccess_Handler {
    ...
    public static function update_htaccess() {
        ...
        $rules = <<<EOD
        # BEGIN Wordpress Speedy

# Check if the query string does NOT contain "nospeedy"
<If "%{QUERY_STRING} !~ /nospeedy/">
...
EOD;
        ...
        if (is_writable($htaccess_file)) {
            ...
            if (strpos($current_content, '# BEGIN Wordpress Speedy') === false) {
    ...
    public static function remove_htaccess_code() {
        ...
        if (file_exists($htaccess_file) && is_writable($htaccess_file)) {   
            ...
            $rules_start = "# BEGIN Wordpress Speedy";
            $rules_end = "# END Wordpress Speedy";
