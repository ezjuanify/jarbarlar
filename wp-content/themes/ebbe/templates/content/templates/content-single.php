			...
			<article id="post-<?php the_ID(); ?>" <?php post_class('post high-padding '. get_post_field( 'post_name', get_post() )); ?>>
			    <div class="container">
			       <div class="row">
			            <?php 
			            // Left Sidebar
			            do_action('ebbe_before_single_post_content'); ?>
			                ...
			                <div class="article-header">
			                    ...
			                    <div class="ebbe-post-metas">
			                        <div class="ebbe-article-details">
			                            ...
			                            do_action('ebbe_before_single_post_metas');
			                            ...
			                            do_action('ebbe_after_single_post_metas');?>
			                            <div class="clearfix"></div>
			            ...
			            <?php 
			            // Right Sidebar
			            do_action('ebbe_after_post_content'); ?>
			        </div>
			    </div>
			</article>
		<?php endwhile; ?>
