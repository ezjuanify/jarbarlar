<?php
class Ebbe_Customizer_Control_Modal extends Ebbe_Customizer_Control_Base {
	static function field_template() {
		echo '<script type="text/html" id="tmpl-field-ebbe-modal">';
		self::before_field();
		?>
		...
		<div class="ebbe-actions">
			...
			<a href="#" title="<?php esc_attr_e( 'Toggle edit panel', 'ebbe' ); ?>" class="action--edit" data-control="{{ field.name }}"><span class="dashicons dashicons-edit"></span></a>
		</div>
