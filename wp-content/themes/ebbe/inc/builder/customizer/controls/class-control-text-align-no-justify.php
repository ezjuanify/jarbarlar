<?php
class Ebbe_Customizer_Control_Text_Align_No_Justify extends Ebbe_Customizer_Control_Base {
	static function field_template() {

		echo '<script type="text/html" id="tmpl-field-ebbe-text_align_no_justify">';
		self::before_field();
		?>
		<#
