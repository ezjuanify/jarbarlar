...
class Ebbe_Builder_Item_Navigation_1 {
	public $id = 'navigation1';

	function item() {
		return array(
			'name'    => esc_html__( 'Navigation 1', 'ebbe' ),
			'id'      => $this->id,
			'width'   => '6',
	...
	function customize() {
		...
		$config  = array(
			array(
				...
				'theme_supports' => '',
				'title'          => esc_html__( 'Navigation 1', 'ebbe' ),
				'description'    => sprintf( __( 'Assign <a href="#menu_locations"  class="focus-section">Menu Location</a> for %1$s', 'ebbe' ), esc_html__( 'Navigation 1', 'ebbe' ) ),
			),

			array(
				'name'            => 'ebbe_navigation1_style',
				'type'            => 'image_select',
				'section'         => $section,
			...
			array(
				'name'       => 'ebbe_navigation1_style_border_h',
				'type'       => 'slider',
				'section'    => $section,
				'selector'   => 'format',
				'max'        => 20,
			...
			array(
				'name'       => 'ebbe_navigation1_style_border_pos',
				'type'       => 'slider',
				'section'    => $section,
				'selector'   => 'format',
				'min'        => - 50,
			...
			array(
				'name'       => 'ebbe_navigation1_style_border_color',
				'type'       => 'color',
				'section'    => $section,
				'selector'   => 'format',
			...
			array(
				'name'           => 'ebbe_navigation1__hide-arrow',
				'type'           => 'checkbox',
				'section'        => $section,
				'selector'       => '.builder-item--' . $this->id . " .{$this->id}",
			...
			array(
				'name'            => 'ebbe_navigation1_arrow_size',
				'type'            => 'slider',
				...
				'required'        => array( 'ebbe_navigation1__hide-arrow', '!=', 1 ),
			),

			array(
				'name'    => 'ebbe_navigation1_top_heading',
				'type'    => 'heading',
				'section' => $section,
			...
			array(
				'name'        => 'ebbe_navigation1_item_styling',
				'type'        => 'styling',
				'section'     => $section,
			...
			array(
				'name'        => 'ebbe_navigation1_typography',
				'type'        => 'typography',
				'section'     => $section,
	 ...
	 */
	function render() {
		$style = sanitize_text_field( Ebbe()->get_setting( 'ebbe_navigation1_style' ) );
		if ( $style ) {
			$style = sanitize_text_field( $style );
		}

		$hide_arrow = sanitize_text_field( Ebbe()->get_setting( 'ebbe_navigation1__hide-arrow' ) );
		if ( $hide_arrow ) {
 ...
 * @return mixed
 */
function ebbe_change_nav_menu_item_id_navigation( $string_id, $item, $args ) {
...
add_filter( 'nav_menu_item_id', 'ebbe_change_nav_menu_item_id_navigation', 55, 3 );


// Register header item.
Ebbe_Customize_Layout_Builder()->register_item( 'header', new Ebbe_Builder_Item_Navigation_1() );
