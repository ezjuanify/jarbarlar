...
class Ebbe_Builder_Item_Navigation_2 {
	public $id = 'navigation2';

	function item() {
		return array(
			'name'    => esc_html__( 'Navigation 2', 'ebbe' ),
			'id'      => $this->id,
			'width'   => '6',
	...
	function customize() {
		...
		$config  = array(
			array(
				...
				'theme_supports' => '',
				'title'          => esc_html__( 'Navigation 2', 'ebbe' ),
				'description'    => sprintf( __( 'Assign <a href="#menu_locations"  class="focus-section">Menu Location</a> for %1$s', 'ebbe' ), esc_html__( 'Navigation 2', 'ebbe' )),
			),

			array(
				'name'            => 'ebbe_navigation2_style',
				'type'            => 'image_select',
				'section'         => $section,
			...
			array(
				'name'       => 'ebbe_navigation2_style_border_h',
				'type'       => 'slider',
				'section'    => $section,
				'selector'   => 'format',
				'max'        => 20,
			...
			array(
				'name'       => 'ebbe_navigation2_style_border_pos',
				'type'       => 'slider',
				'section'    => $section,
				'selector'   => 'format',
				'min'        => - 50,
			...
			array(
				'name'       => 'ebbe_navigation2_style_border_color',
				'type'       => 'color',
				'section'    => $section,
				'selector'   => 'format',
			...
			array(
				'name'           => 'ebbe_navigation2__hide-arrow',
				'type'           => 'checkbox',
				'section'        => $section,
				'selector'       => '.builder-item--' . $this->id . " .{$this->id}",
			...
			array(
				'name'            => 'ebbe_navigation2_arrow_size',
				'type'            => 'slider',
				...
				'required'        => array( 'ebbe_navigation2__hide-arrow', '!=', 1 ),
			),

			array(
				'name'    => 'ebbe_navigation2_top_heading',
				'type'    => 'heading',
				'section' => $section,
			...
			array(
				'name'        => 'ebbe_navigation2_item_styling',
				'type'        => 'styling',
				'section'     => $section,
			...
			array(
				'name'        => 'ebbe_navigation2_typography',
				'type'        => 'typography',
				'section'     => $section,
	 ...
	 */
	function render() {
		$style = sanitize_text_field( Ebbe()->get_setting( 'ebbe_navigation2_style' ) );
		if ( $style ) {
			$style = sanitize_text_field( $style );
		}

		$hide_arrow = sanitize_text_field( Ebbe()->get_setting( 'ebbe_navigation2__hide-arrow' ) );
		if ( $hide_arrow ) {
 ...
 * @return mixed
 */
function ebbe_change_nav_menu_item_id_navigation2( $string_id, $item, $args ) {
...
add_filter( 'nav_menu_item_id', 'ebbe_change_nav_menu_item_id_navigation2', 55, 3 );

// Register header item.
Ebbe_Customize_Layout_Builder()->register_item( 'header', new Ebbe_Builder_Item_Navigation_2() );
