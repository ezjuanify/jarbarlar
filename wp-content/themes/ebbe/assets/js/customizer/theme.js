...
// // Add 'active' class when search icon is clicked
// $('.search-icon').click(function(event) {
//     event.stopPropagation(); // Prevent the click event from propagating to the document
//     $('.cb-row--mobile .header-search_icon-item.item--search_icon').addClass('active');
// });

// // Remove 'active' class when clicking outside the search container
// $(document).click(function(event) {
//     if (!$(event.target).closest('.cb-row--mobile .header-search_icon-item.item--search_icon').length && !$(event.target).closest('.search-icon').length) {
//         $('.cb-row--mobile .header-search_icon-item.item--search_icon').removeClass('active');
//     }
// });
 
// // $('.header-search_icon-item:nth-child(1) ').click(function(event) {
...
$('.search-icon').click(function(event) {
    event.stopPropagation(); // Prevent the click event from propagating to the document
    $('.cb-row--mobile .header-search_icon-item.item--search_icon').toggleClass('active');
});

// Remove 'active' class when clicking outside the search container
$(document).click(function(event) {
    if (!$(event.target).closest('.cb-row--mobile .header-search_icon-item.item--search_icon, .search-icon').length) {
        $('.cb-row--mobile .header-search_icon-item.item--search_icon').removeClass('active');
    }
});
