...
(function($, api) {
	...
	var header_changed = function(partial_id, remove_items) {
		...
		if (
			...
			partial_id === "ebbe_customize_render_header"
		) {
	...
	api.bind("preview-ready", function() {
		...
		function setupPreviewNamePosition() {
			$(".ebbe-grid .has_menu.builder-item-focus").each(function() {
				var parentPos = $(this)
					.closest(".ebbe-grid")
					.offset();
	...
	var skips_to_add_shortcut = {
		ebbe_customize_render_header: 1,
		ebbe_customize_render_footer: 1
	};
