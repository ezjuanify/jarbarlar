...
jQuery(document).ready(function($) {
    if( $( '.variations select' ).length == 0 ||  
    	$( '.ebbe-header-searchform select' ).length == 0 || 
    	$( '.widget_archive select' ).length == 0 || 
    	$( '.widget_categories select' ).length == 0 || 
    	$( '.widget_text select' ).length == 0  || 
    	$( '.woocommerce-ordering select' ).length == 0 ) {
        $('.variations select, .ebbe-header-searchform select, .widget_archive select, .widget_categories select, .widget_text select, .woocommerce-ordering select').select2({
