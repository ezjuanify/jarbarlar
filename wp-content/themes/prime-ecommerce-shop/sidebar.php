...
if ( ! is_active_sidebar( 'right-sidebar' ) && $prime_ecommerce_shop_sidebar_position !== 'no-sidebar' ) { ?>
	<aside id="secondary" class="widget-area" role="complementary">
		...
		<!-- Categories -->
		<aside id="categories" class="widget widget_categories" role="complementary" aria-label="<?php esc_attr_e( 'secondsidebar', 'prime-ecommerce-shop' ); ?>">
...
if ( $prime_ecommerce_shop_sidebar_position !== 'no-sidebar' ) :
